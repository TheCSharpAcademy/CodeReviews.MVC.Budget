...
async function deleteCategory(id) {
    await deleteEntity("Category", `${categoriesUri}/Delete/${id}`, homePageCategoriesTab);
}
...
async function deleteEntity(entityName, uri, successRedirect) {
    showConfirmationModal({
        title: `Delete ${entityName}`,
        body: `Are you sure you want to delete ${entityName.toLowerCase()}`,
        isDestructive: true,
        action: `Delete`,
        onConfirm: async () => {
            const response = await fetch(uri, {
